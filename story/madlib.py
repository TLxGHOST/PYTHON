...
root.title('Anshu')
Label(root, text= 'STORY GENERATOR \n Have Fun!' , font = 'arial 20 bold').pack()
...
def madlib2():
    ...
    print('Last night I dreamed I was a ' +adjactive+ ' butterfly with ' + color+ ' splocthes that looked like '+thing+ ' .I flew to ' + place+ ' with my bestfriend  '+person+ ' who is a '+adjactive1+ ' ' +insect +' .We ate some ' +food+ '. We got there and then decided to '+verb+ ' and the dream ended and when  I saw '+person+' said-- lets ' +verb+ '.')
...
Button(root, text= 'Food Story', font ='arial 15', command = madlib3 , bg = 'ghost white').place(x=70, y=180)
